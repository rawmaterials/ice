...
from recipes.primer.answer_by_computation import answer_by_computation
from recipes.primer.answer_by_reasoning import answer_by_reasoning
from recipes.primer.answer_by_search import answer_by_search
