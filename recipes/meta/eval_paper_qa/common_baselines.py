...
from recipes.meta.eval_paper_qa.types import PaperQaMethod
from recipes.meta.eval_paper_qa.utils import convert_demonstration_example
from recipes.meta.eval_paper_qa.utils import identify_gs_str
from recipes.primer.paper_qa import answer_for_paper
from recipes.primer.qa import answer
from recipes.program_search.nodes.answer.answer import demonstration_answer
from recipes.program_search.nodes.answer.answer import (
    demonstration_answer_with_reasoning,
)
from recipes.program_search.nodes.answer.types import Demonstration
from recipes.program_search.nodes.select.select import as_bool
